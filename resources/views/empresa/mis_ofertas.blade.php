                        ...
                        <tr>
                            ...
                            <td>
                                <div class="grupo-acciones">
                                    ...
                                    <form action="{{ route('ofertas.destroy', $o->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Seguro que quieres borrar esta oferta?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn-borrar-oferta" style="border:none; background:none; cursor:pointer;">
